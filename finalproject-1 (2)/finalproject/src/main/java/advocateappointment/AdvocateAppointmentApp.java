...
//        }
    	...
    	Appointment obj= new Appointment(customer_Obj.getC_Id(),advocate_Obj.getA_Id(),ap_Date);
...
//    	//String ap_Date= scanner.nextLine();
//    	
//    	Appointment obj= new Appointment(ap_Id,c_Obj.getC_Id(),a_Obj.getA_Id(),dateInput);
...
//*************************CUSTOMER METHODA******************************
    ...
    public static void customerRegister() {
    	...
    	Customer obj = new Customer(id,name,contactNumber,email,address);
    	try {
